return {
    ...
    exteriorModeInfo={
        ...
        techrash_easy=         {"Chỉ làm Techrash - Dễ","Cố làm nhiều Techrash nhất có thể (không được dùng kiểu xóa nào khác)"},
        ...
        tsd_hard=              {"Chỉ làm TSD - Khó","Hãy cố làm nhiều TSD nhất có thể, nhưng đừng có làm cùng chung một vị trí quá nhiều lần!"},
        ...
        sprint_wind_40=        {"40 hàng - Wind","Xóa 40 hàng, nhưng mà… trời đang có bão!"},
        sprint_lock_20=        {"20 hàng - Lock","Xóa 20 hàng, nhưng không thể xoay gạch"},
        sprint_fix_20=         {"20 hàng - Fix","Xóa 20 hàng, nhưng không thể di chuyển gạch"},
        sprint_hide_40=        {"40 hàng - Hide","Xóa 40 hàng, nhưng toàn bộ gạch ở trên bảng sẽ dần trong suốt theo thời gian"},
        sprint_invis_40=       {"40 hàng - Invis","Xóa 40 hàng, nhưng gạch đặt xong là biến mất liền"},
        ...
        sprint_flip_40=        {"40 hàng - Flip","Xóa 40 hàng, nhưng cái bảng sẽ bị lật ngang sau mỗi lần đặt gạch\n\nYou spin me right round, baby right round like a record, baby right round right round"},
        sprint_dizzy_40=       {"40 hàng - Dizzy","Xóa 40 hàng nhưng có gì đó không đúng với cái điều khiển ở đây."},
        sprint_float_40=       {"40 hàng - Float","Xóa 40 hàng nhưng không có trọng lực (trôi nổi bồng bềnh như đám mây vậy ấy)"},
        sprint_randctrl_40=    {"40 hàng - Random","Xóa 40 hàng nhưng bộ điều khiển bị kẹt phím liên tục không dứt!"},
    },
