...
@ title_full 可选，显示在正文页面的完整词条标题，不写就同title，有多个也视为多行标题
...
翻译说明：
    ...
    2. 在菜单介绍/教程类型的词条中，尽可能保留对玩家的称呼，营造一些对话感
    3. 在术语/技巧词条中，尽可能使描述严肃，不要出现“游戏”“玩家”等在本语言环境下“明显带有娱乐意味”的、“直接指向玩家的”词汇（可以变换句式来避开）
...
# his_sequence
@ title His出块
History（历史记录），一类序列生成方式，具体的类型例如His4 Roll6（h4r6），效果是在随机生成新的 Next 的时候，在七个块中直接随机一个，但会查看最近4个生成的方块，如果有一样的就重新随机，直到和最近四个都不一样，或者尝试了6次。
