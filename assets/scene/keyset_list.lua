...
scene.widgetList={
    ...
    WIDGET.new{type='button', name='gem', x=140, y=350,  w=200,h=60,text=LANG"keyset_gem_twistCW",     fontSize=20, color='lG',code=selAct('gem', 'twistCW'  )},
    WIDGET.new{type='button', name='gem', x=140, y=420,  w=200,h=60,text=LANG"keyset_gem_twistCCW",    fontSize=20, color='lG',code=selAct('gem', 'twistCCW' )},
    WIDGET.new{type='button', name='gem', x=140, y=490,  w=200,h=60,text=LANG"keyset_gem_twist180",    fontSize=20, color='lG',code=selAct('gem', 'twist180' )},
    ...
    WIDGET.new{type='button', name='sys', x=140, y=70,   w=200,h=60,text=LANG"keyset_sys_view",        fontSize=20, color='lC',code=selAct('sys', 'view'   )},
    WIDGET.new{type='button', name='sys', x=140, y=140,  w=200,h=60,text=LANG"keyset_sys_restart",     fontSize=20, color='lC',code=selAct('sys', 'restart')},
    WIDGET.new{type='button', name='sys', x=140, y=210,  w=200,h=60,text=LANG"keyset_sys_back",        fontSize=20, color='lC',code=selAct('sys', 'back'   )},
    WIDGET.new{type='button', name='sys', x=140, y=280,  w=200,h=60,text=LANG"keyset_sys_setting",     fontSize=20, color='lC',code=selAct('sys', 'setting')},
    WIDGET.new{type='button', name='sys', x=140, y=350,  w=200,h=60,text=LANG"keyset_sys_chat",        fontSize=20, color='lC',code=selAct('sys', 'chat'   )},
    WIDGET.new{type='button', name='sys', x=140, y=420,  w=200,h=60,text=LANG"keyset_sys_up",          fontSize=20, color='lC',code=selAct('sys', 'up'     )},
    WIDGET.new{type='button', name='sys', x=140, y=490,  w=200,h=60,text=LANG"keyset_sys_down",        fontSize=20, color='lC',code=selAct('sys', 'down'   )},
    WIDGET.new{type='button', name='sys', x=140, y=560,  w=200,h=60,text=LANG"keyset_sys_left",        fontSize=20, color='lC',code=selAct('sys', 'left'   )},
    WIDGET.new{type='button', name='sys', x=140, y=630,  w=200,h=60,text=LANG"keyset_sys_right",       fontSize=20, color='lC',code=selAct('sys', 'right'  )},
    WIDGET.new{type='button', name='sys', x=140, y=700,  w=200,h=60,text=LANG"keyset_sys_select",      fontSize=20, color='lC',code=selAct('sys', 'select' )},
