...
scene.widgetList={
    ...
    {type='slider',   name='asd',  pos={1,.5},x=-852.3,y=150,w=702.3,fontSize=40,text="ASD",widthLimit=260,axis={20,260,10},disp=TABLE.func_getVal(SETTINGS.game_brik,'asd'),valueShow=sliderShow_time,code=function(v)
    ...
    {type='slider',   name='asp',  pos={1,.5},x=-852.3,y=250,w=702.3,fontSize=40,text="ASP",widthLimit=260,axis={0,120,10}, disp=TABLE.func_getVal(SETTINGS.game_brik,'asp'),valueShow=sliderShow_time,code=function(v)
        SETTINGS.game_brik.asp=v
        SETTINGS.game_brik.asd=math.max(SETTINGS.game_brik.asd,SETTINGS.game_brik.asp)
        updateSlidercolor()
    end},
    {type='slider',   name='adp',  pos={1,.5},x=-852.3,y=350,w=702.3,fontSize=40,text="ADP",widthLimit=260,axis={0,120,10}, disp=TABLE.func_getVal(SETTINGS.game_brik,'adp'),valueShow=sliderShow_time,code=function(v)
