...
scene.widgetList={
    {name='pause',type='button',pos={0,.5},x=210,y=-360,w=200,h=80,lineWidth=4,cornerR=0,sound_release='button_back',fontSize=60,text=CHAR.icon.pause,onClick=function() sysAction('back') end},
}
return scene
