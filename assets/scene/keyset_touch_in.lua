...
scene.widgetList={
    ...
    {type='button',                pos={.5,.5},x=-330,y=-360,w=200,h=80,fontSize=25,text=LANG'stick2_switch',code=WIDGET.c_pressKey('q'),lineWidth=4,cornerR=0},
    {type='button',                pos={.5,.5},x=-330,y=-270,w=200,h=80,fontSize=25,text=LANG'stick4_switch',code=WIDGET.c_pressKey('w'),lineWidth=4,cornerR=0},

    {type='button',                pos={.5,.5},x=40,  y=-350,w=100,fontSize=80,text='-',code=WIDGET.c_pressKey('-'),lineWidth=4,cornerR=0},
    {type='button',                pos={.5,.5},x=560, y=-350,w=100,fontSize=80,text='+',code=WIDGET.c_pressKey('+'),lineWidth=4,cornerR=0},
    ...
    {type='button',name='button2', pos={.5,.5},x=430, y=-120,w=360,h=100,fontSize=40, text=LANG'setting_touch_buttonShape', code=WIDGET.c_pressKey('0'),lineWidth=4,cornerR=0},
