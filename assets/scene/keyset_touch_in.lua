...
scene.widgetList={
    {type='button',                pos={0,.5}, x=210, y=-360,w=200,h=80,sound_trigger='button_back',fontSize=60,text=CHAR.icon.back,onPress=WIDGET.c_backScn('none'),lineWidth=4,cornerR=0},

    {type='button',                pos={.5,.5},x=-330,y=-360,w=200,h=80,fontSize=25,text=LANG'stick2_switch',onPress=WIDGET.c_pressKey('q'),lineWidth=4,cornerR=0},
    {type='button',                pos={.5,.5},x=-330,y=-270,w=200,h=80,fontSize=25,text=LANG'stick4_switch',onPress=WIDGET.c_pressKey('w'),lineWidth=4,cornerR=0},

    {type='button',                pos={.5,.5},x=40,  y=-350,w=100,fontSize=80,text='-',onPress=WIDGET.c_pressKey('-'),lineWidth=4,cornerR=0},
    {type='button',                pos={.5,.5},x=560, y=-350,w=100,fontSize=80,text='+',onPress=WIDGET.c_pressKey('+'),lineWidth=4,cornerR=0},
    ...
    {type='button',name='button2', pos={.5,.5},x=430, y=-120,w=360,h=100,fontSize=40, text=LANG'setting_touch_buttonShape', onPress=WIDGET.c_pressKey('0'),lineWidth=4,cornerR=0},
