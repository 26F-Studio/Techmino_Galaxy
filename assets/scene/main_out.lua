...
scene.widgetList={
    ...
    WIDGET.new{type='button',   x=325,  y=580,w=530,h=100,text=function() return CHAR.icon.person    ..' '..Text.main_out_single    end, fontSize=40,cornerR=26,code=WIDGET.c_goScn''},
    WIDGET.new{type='button',   x=895,  y=580,w=530,h=100,text=function() return CHAR.icon.people    ..' '..Text.main_out_multi     end, fontSize=40,cornerR=26,code=WIDGET.c_goScn''},
