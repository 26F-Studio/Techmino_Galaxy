...
scene.widgetList={
    WIDGET.new{type='button',pos={.5,.5},x=-300,y=0,w=260,h=260,sound=false,code=function() answer(1) end},
    WIDGET.new{type='button',pos={.5,.5},x=300,y=0,w=260,h=260,sound=false,code=function() answer(2) end},
