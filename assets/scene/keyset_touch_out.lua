...
scene.widgetList={
    ...
    WIDGET.new{type='button',pos={0,.5},  x=520,y=-360,w=200,h=80,fontSize=25,text=LANG'stick2_switch',code=WIDGET.c_pressKey('q')},
    WIDGET.new{type='button',pos={0,.5},  x=520,y=-270,w=200,h=80,fontSize=25,text=LANG'stick4_switch',code=WIDGET.c_pressKey('w')},

    WIDGET.new{type='button',x=940, y=150,w=100,fontSize=80,text='-',code=WIDGET.c_pressKey('-')},
    WIDGET.new{type='button',x=1460,y=150,w=100,fontSize=80,text='+',code=WIDGET.c_pressKey('+')},
