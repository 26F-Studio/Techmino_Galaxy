...
scene.widgetList={
    ...
    WIDGET.new{type='button',name='mino',x=900,y=550,w=200,h=60,text=LANG"keyset_func6",           fontSize=20, color='lY',code=selAct('mino','func6')},
    ...
    WIDGET.new{type='button',name='puyo',x=900,y=550,w=200,h=60,text=LANG"keyset_func6",           fontSize=20, color='lY',code=selAct('puyo','func6')},
    ...
    WIDGET.new{type='button',name='gem', x=900,y=550,w=200,h=60,text=LANG"keyset_func6",           fontSize=20, color='lY',code=selAct('gem', 'func6')},
    ...
    WIDGET.new{type='button',name='sys', x=140,y=340,w=200,h=60,text=LANG"keyset_sys_back",        fontSize=20, color='lC',code=selAct('sys', 'back'   )},
    WIDGET.new{type='button',name='sys', x=140,y=410,w=200,h=60,text=LANG"keyset_sys_quit",        fontSize=20, color='lC',code=selAct('sys', 'quit'   )},
    WIDGET.new{type='button',name='sys', x=140,y=480,w=200,h=60,text=LANG"keyset_sys_setting",     fontSize=20, color='lC',code=selAct('sys', 'setting')},
    WIDGET.new{type='button',name='sys', x=140,y=550,w=200,h=60,text=LANG"keyset_sys_help",        fontSize=20, color='lC',code=selAct('sys', 'help'   )},
    WIDGET.new{type='button',name='sys', x=900,y=200,w=200,h=60,text=LANG"keyset_sys_chat",        fontSize=20, color='lC',code=selAct('sys', 'chat'   )},
    WIDGET.new{type='button',name='sys', x=900,y=270,w=200,h=60,text=LANG"keyset_sys_up",          fontSize=20, color='lC',code=selAct('sys', 'up'     )},
    WIDGET.new{type='button',name='sys', x=900,y=340,w=200,h=60,text=LANG"keyset_sys_down",        fontSize=20, color='lC',code=selAct('sys', 'down'   )},
    WIDGET.new{type='button',name='sys', x=900,y=410,w=200,h=60,text=LANG"keyset_sys_left",        fontSize=20, color='lC',code=selAct('sys', 'left'   )},
    WIDGET.new{type='button',name='sys', x=900,y=480,w=200,h=60,text=LANG"keyset_sys_right",       fontSize=20, color='lC',code=selAct('sys', 'right'  )},
    WIDGET.new{type='button',name='sys', x=900,y=550,w=200,h=60,text=LANG"keyset_sys_select",      fontSize=20, color='lC',code=selAct('sys', 'select' )},

    WIDGET.new{type='button_invis',name='Sgem', pos={1,0},x=-800,y=60,w=150,h=100,cornerR=20,fontSize=60,text="G",fontType='bold',sound_trigger='move',code=function() if keyMode~='gem'  then scene.enter('gem')  end end,visibleFunc=PROGRESS.getGemUnlocked},
    WIDGET.new{type='button_invis',name='Spuyo',pos={1,0},x=-600,y=60,w=150,h=100,cornerR=20,fontSize=60,text="P",fontType='bold',sound_trigger='move',code=function() if keyMode~='puyo' then scene.enter('puyo') end end,visibleFunc=PROGRESS.getPuyoUnlocked},
    WIDGET.new{type='button_invis',name='Smino',pos={1,0},x=-400,y=60,w=150,h=100,cornerR=20,fontSize=60,text="M",fontType='bold',sound_trigger='move',code=function() if keyMode~='mino' then scene.enter('mino') end end,visibleFunc=PROGRESS.getMinoUnlocked},
