...
scene.widgetList={
    ...
    {type='button_invis',name='Sacry', pos={1,0},x=-800,y=60,w=150,h=100,cornerR=20,fontSize=60,text="G",fontType='bold',sound_trigger='button_soft',code=function() if keyMode~='acry'  then scene.enter('acry')  end end,visibleFunc=function() return PROGRESS.getModeUnlocked('acry_wip') end},
    {type='button_invis',name='Sgela',pos={1,0},x=-600,y=60,w=150,h=100,cornerR=20,fontSize=60,text="P",fontType='bold',sound_trigger='button_soft',code=function() if keyMode~='gela' then scene.enter('gela') end end,visibleFunc=function() return PROGRESS.getModeUnlocked('gela_wip') end},
    {type='button_invis',name='Sbrik',pos={1,0},x=-400,y=60,w=150,h=100,cornerR=20,fontSize=60,text="M",fontType='bold',sound_trigger='button_soft',code=function() if keyMode~='brik' then scene.enter('brik') end end,visibleFunc=function() return PROGRESS.getModeUnlocked('brik_stdMap') end},
