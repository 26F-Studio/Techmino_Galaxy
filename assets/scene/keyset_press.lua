...
function scene.draw()
    ...
    FONT.set(60)  GC.strokePrint('full',2,COLOR.D,COLOR.L,result or Text.keyset_pressKey,0,-40,nil,'center')
...
scene.widgetList={
    {type='button',pos={1,0},x=-300,y=80,w=160,h=80,sound_release=false,fontSize=60,text=CHAR.key.backspace,onClick=WIDGET.c_pressKey('backspace')},
    {type='button',pos={1,0},x=-120,y=80,w=160,h=80,sound_release='button_back',fontSize=60,text=CHAR.icon.back,onClick=function() SCN.back('none',SCN.args[1]) end},
}
