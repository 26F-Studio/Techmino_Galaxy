...
scene.widgetList={
    WIDGET.new{type='button',         x=350,y=310,w=390,h=100,fontSize=40, text=langList.en, color='R', sound='check',code=function() _setLang('en') end},
    WIDGET.new{type='button_fill',    x=350,y=460,w=390,h=100,fontSize=40, text='',          color='F'},
    WIDGET.new{type='button_fill',    x=350,y=610,w=390,h=100,fontSize=35, text='',          color='O'},
    WIDGET.new{type='button_fill',    x=350,y=760,w=390,h=100,fontSize=35, text='',          color='Y'},
    ...
    WIDGET.new{type='button_fill',    x=1250,y=460,w=390,h=100,fontSize=40,text='',          color='B'},
    WIDGET.new{type='button_fill',    x=1250,y=610,w=390,h=100,fontSize=40,text='',          color='P'},

    WIDGET.new{type='button',x=1250,y=760,w=390,h=100,sound='back',fontSize=60,text=CHAR.icon.back,code=WIDGET.c_backScn},
}
