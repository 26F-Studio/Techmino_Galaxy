...
scene.widgetList={
    ...
    -- Controls
    {name='1',type='slider', pos={0,0},x=340, y=220,w=650, fontSize=35,text="ASD",widthLimit=260,axis={0,260,1},unit=false,disp=TABLE.func_getVal(SETTINGS.game_brik,'asd'),  valueShow=sliderShow_time, code=function(v)
    ...
    {name='1',type='slider', pos={0,0},x=340, y=300,w=300, fontSize=35,text="ASP",widthLimit=260,axis={0,120,1},unit=false,disp=TABLE.func_getVal(SETTINGS.game_brik,'asp'),  valueShow=sliderShow_time, code=function(v)
        SETTINGS.game_brik.asp=v
        SETTINGS.game_brik.asd=math.max(SETTINGS.game_brik.asd,SETTINGS.game_brik.asp)
    end},
    {name='1',type='slider', pos={0,0},x=340, y=380,w=300, fontSize=35,text="ADP",widthLimit=260,axis={0,120,1},unit=false,disp=TABLE.func_getVal(SETTINGS.game_brik,'adp'),  valueShow=sliderShow_time, code=function(v)
    ...
    {name='1',type='slider', pos={0,0},x=340, y=460,w=650,                  fontSize=35,text="ASH",widthLimit=260,axis={0,260,1},unit=false,disp=TABLE.func_getVal(SETTINGS.game_brik,'ash'),  valueShow=sliderShow_time, code=function(v) SETTINGS.game_brik.ash=v; SETTINGS.game_brik.asd=math.max(SETTINGS.game_brik.asd,SETTINGS.game_brik.ash) end},
    ...
    {name='2',type='switch',     pos={0,0},x=390, y=540,h=45,  fontSize=40,text=LANG'setting_autoMute',widthLimit=550, disp=TABLE.func_getVal(SETTINGS.system,'autoMute'), code=TABLE.func_revVal(SETTINGS.system,'autoMute')},
    ...
    {name='3', type='slider',     pos={0,0},x=340, y=300,w=500,     text=LANG'setting_maxTPS',      widthLimit=260,axis={120,400,10},unit=false,disp=TABLE.func_getVal(SETTINGS.system,'maxTPS'),    valueShow=sliderShow_maxTPS,code=TABLE.func_setVal(SETTINGS.system,'maxTPS')},
    ...
    {name='3', type='switch',     pos={1,0},x=-500,y=220,h=45,      text=LANG'setting_sysCursor',   widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'sysCursor'),   code=TABLE.func_revVal(SETTINGS.system,'sysCursor')},
    {name='3', type='switch',     pos={1,0},x=-500,y=290,h=45,      text=LANG'setting_power',       widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'powerInfo'),   code=TABLE.func_revVal(SETTINGS.system,'powerInfo')},
    {name='3', type='switch',     pos={1,0},x=-500,y=360,h=45,      text=LANG'setting_clean',       widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'cleanCanvas'), code=TABLE.func_revVal(SETTINGS.system,'cleanCanvas')},
    {name='3f',type='switch',     pos={1,0},x=-500,y=430,h=45,      text=LANG'setting_fullscreen',  widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'fullscreen'),  code=TABLE.func_revVal(SETTINGS.system,'fullscreen')},
    {name='3p',type='switch',     pos={1,0},x=-500,y=430,h=45,      text=LANG'setting_portrait',    widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'portrait'),    code=function() SETTINGS.system.portrait = not SETTINGS.system.portrait; SaveSettings(); if TASK.lock('warnMessage',6.26) then MSG('warn',Text.setting_needRestart,6.26) end end},
    {name='3', type='switch',     pos={1,0},x=-500,y=500,h=45,      text=LANG'setting_showTouch',   widthLimit=260,disp=TABLE.func_getVal(SETTINGS.system,'showTouch'),   code=TABLE.func_revVal(SETTINGS.system,'showTouch')},
