...
scene.widgetList={
    ...
    {name='1',type='slider', pos={0,0},x=340, y=380,w=250, fontSize=40,text=LANG'setting_sdarr',   widthLimit=260,axis={0,100,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'sdarr'),   valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'sdarr')},
