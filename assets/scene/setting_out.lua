...
scene.widgetList={
    ...
    {name='1',type='slider', pos={0,0},x=340, y=460,w=650, fontSize=30,text=LANG'setting_asHalt', widthLimit=260,axis={0,260,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'asHalt'), valueShow=sliderShow_time, code=function(v) SETTINGS.game_mino.asHalt=v; SETTINGS.game_mino.asd=math.max(SETTINGS.game_mino.asd,SETTINGS.game_mino.asHalt) end},
