...
scene.widgetList={
    ...
    {name='1',type='switch', pos={0,0},x=750, y=300,h=40,  labelPos='right',fontSize=35,text=LANG'setting_softdropSkipAsd',disp=TABLE.func_getVal(SETTINGS.game_mino,'softdropSkipAsd'),code=TABLE.func_revVal(SETTINGS.game_mino,'softdropSkipAsd')},-- visibleTick=function() return page=='1' and SETTINGS.game_mino.asp>0 end
