...
scene.widgetList={
    ...
    WIDGET.new{name='1',type='button', pos={0,0},x=500, y=720,w=360, h=80,cornerR=10, fontSize=40,text=LANG'setting_keymapping',     code=WIDGET.c_goScn('keyset_list','fadeHeader')},
