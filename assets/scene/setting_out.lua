...
scene.widgetList={
    ...
    {name='S3',type='button_invis',pos={1,0},x=-400,y=60,w=150,h=100,cornerR=20,fontSize=70,text=CHAR.icon.image,    sound_trigger='button_soft',code=function() if page~='3' then SCN.swapTo('setting_out','none',3) end end},
    {name='S4',type='button_invis',pos={1,0},x=-200,y=60,w=150,h=100,cornerR=20,fontSize=70,text=CHAR.icon.bookmark, sound_trigger='button_soft',code=function() if page~='4' then SCN.swapTo('setting_out','none',4) end end},
    ...
    {name='2',type='button',     pos={0,0},x=400, y=870,w=140, h=60,       text=LANG'setting_apply', code=function()
