...
scene.widgetList={
    ...
    -- Controls
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=220,w=650, fontSize=40,text=LANG'setting_das',     widthLimit=260,axis={0,260,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'das'),     valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'das')},
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=300,w=650, fontSize=40,text=LANG'setting_arr',     widthLimit=260,axis={0,120,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'arr'),     valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'arr')},
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=380,w=650, fontSize=40,text=LANG'setting_sdarr',   widthLimit=260,axis={0,100,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'sdarr'),   valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'sdarr')},
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=460,w=650, fontSize=30,text=LANG'setting_dasHalt', widthLimit=260,axis={0,100,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'dasHalt'), valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'dasHalt')},
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=540,w=650, fontSize=30,text=LANG'setting_hdLockA', widthLimit=260,axis={0,100,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'hdLockA'), valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'hdLockA')},
    WIDGET.new{name='1',type='slider', pos={0,0},x=340, y=620,w=650, fontSize=30,text=LANG'setting_hdLockM', widthLimit=260,axis={0,100,1},smooth=true,disp=TABLE.func_getVal(SETTINGS.game_mino,'hdLockM'), valueShow=sliderShow_time, code=TABLE.func_setVal(SETTINGS.game_mino,'hdLockM')},
    WIDGET.new{name='1',type='button', pos={0,0},x=500, y=740,w=360, h=80,cornerR=10, fontSize=40,text=LANG'setting_keymapping',     code=function() SCN.go('keyset_list',nil,'mino') end},
