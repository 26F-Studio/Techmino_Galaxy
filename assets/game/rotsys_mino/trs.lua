...
TRS[5]={
    ...
    [1]={
        ...
        L={test={'+0+0','+1+0','+1-1','+0+2','+1+2','+0+1','+0-1'}},
        F={test={'+0+0','+0-1','+0+1','+1+0','+0-2','+0+2'}},
    },
    [2]={
        R={test={'+0+0','+1+0','+0-2','+1-2','+1-1','+0-1','-1+1','-1+0'}},
        L={test={'+0+0','-1+0','+0-2','-1-2','-1-1','+0-1','+1+1','+1+0'}},
        F={test={'+0+0','+1+0','-1+0','+0-1'}},
    },
    [3]={
        R={test={'+0+0','-1+0','-1-1','+0+2','-1+2','+0+1','+0-1'}},
