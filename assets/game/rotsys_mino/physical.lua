...
Physical[4]={-- L
    [0]={
        ...
        F={base=Physical[3][0].F.base,test=minoRotSys._flipList(Physical[3][0].F.test)},
    },
    [1]={
        R={base=Physical[3][1].R.base,test=minoRotSys._flipList(Physical[3][3].L.test)},
        L={base=Physical[3][1].L.base,test=minoRotSys._flipList(Physical[3][3].R.test)},
        F={base=Physical[3][1].F.base,test=minoRotSys._flipList(Physical[3][3].F.test)},
    },
    [2]={
        R={base=Physical[3][2].R.base,test=minoRotSys._flipList(Physical[3][2].L.test)},
        L={base=Physical[3][2].L.base,test=minoRotSys._flipList(Physical[3][2].R.test)},
        F={base=Physical[3][2].F.base,test=minoRotSys._flipList(Physical[3][2].F.test)},
    },
    [3]={
        R={base=Physical[3][3].R.base,test=minoRotSys._flipList(Physical[3][1].L.test)},
        L={base=Physical[3][3].L.base,test=minoRotSys._flipList(Physical[3][1].R.test)},
