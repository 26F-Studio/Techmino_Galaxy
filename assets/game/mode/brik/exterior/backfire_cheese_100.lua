...
return {
    ...
    settings={brik={
        ...
        event={
            ...
            beforeSend=mechLib.brik.backfire.break_event_beforeSend,
            afterClear={
                mechLib.brik.sprint.event_afterClear[100],
                mechLib.brik.music.backfire_cheese_100_afterClear,
            },
            drawInField=mechLib.brik.sprint.event_drawInField[100],
            drawOnPlayer=mechLib.brik.sprint.event_drawOnPlayer[100],
            gameOver=mechLib.brik.progress.backfire_cheese_100_gameOver,
        },
    }},
}
