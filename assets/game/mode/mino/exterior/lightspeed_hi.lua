...
local levels={
    {lock=500,fresh=4400,spawn=150,clear=380,das=130,arr=26},
    {lock=420,fresh=4200,spawn=140,clear=340,das=120,arr=24},
    {lock=350,fresh=4000,spawn=130,clear=300,das=110,arr=22},
    {lock=290,fresh=3800,spawn=120,clear=260,das=105,arr=20},
    {lock=240,fresh=3600,spawn=110,clear=220,das=100,arr=18},
    {lock=200,fresh=3400,spawn=100,clear=180,das=96, arr=16},
    {lock=170,fresh=3200,spawn=95, clear=160,das=92, arr=14},
    {lock=150,fresh=3000,spawn=90, clear=140,das=88, arr=13},
    {lock=140,fresh=2800,spawn=85, clear=120,das=84, arr=12},
    {lock=130,fresh=2600,spawn=80, clear=100,das=80, arr=11},
}
